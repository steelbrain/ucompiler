...
function saveFile(contents, config, _ref, state) {
  ...
  if (output === '-') {
    ...
    const absoluteDir = (0, _common.normalizePath)(_path2.default.dirname(absolutePath));
    const relativeDir = (0, _common.normalizePath)(_path2.default.relative(root, absoluteDir));
    ...
    debug(`Saving ${ relativePath } to ${ (0, _common.normalizePath)(_path2.default.relative(root, outputPath)) }`);
